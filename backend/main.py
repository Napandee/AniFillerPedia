...
app = FastAPI(
    ...
    description=(
        ...
        "admin) require login.\n\n"
        "Auth is cookie-based, with three ways to sign in — OAuth (GitHub/"
        "Discord) or a first-class local email+password account — and no "
        "bearer-token alternative today; see the Authentication section of "
