...
const en = {
  ...
  "series.suggestSynonym": "Suggest a synonym",
...
const es: Partial<Record<TranslationKey, string>> = {
  ...
  "nav.adminPortal": "Administración",
  "nav.account": "Cuenta",
  ...
  "series.suggestSynonym": "Sugerir un sinónimo",
...
const hi: Partial<Record<TranslationKey, string>> = {
  ...
  "series.suggestSynonym": "एक पर्यायवाची सुझाएं",
